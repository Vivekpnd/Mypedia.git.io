...
// conatctpage section//
 function sendEmail(){
    Email.send({
        Host : "smtp.gamil.com",
        Username : "vivekpnd4321@gmail.com",
        Password : "vive8287",
        To : "21set127vivek@student.gangatechnicalcampus.com",
        From : document.getElementById("Email").value,
        Subject : "New contact form",
        Body : "Name:" + document.getElementById("full-name").value
        + " <br> Email:" + document.getElementById("Email").value
        + " <br> Phone No:" + document.getElementById("number").value
        + " <br> Message:" + document.getElementById("text-area").value
        }).then(
            message => alert("Query Submitted")
        );
 }
